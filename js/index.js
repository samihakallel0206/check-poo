//creation dynamique avec le createElement et le appendChild
...
class ShoppingCart {
  ...
  displayCart() {
    ...
    this.items.forEach((item) => {
      ...
      img.src = item.product.image; // Utilisation du chemin dynamique de l'image
      ...
      minusIcon.classList.add("fas", "fa-minus-circle");
...
// Ajout des produits dans le panier (tu devras passer les bons ids et autres propriétés pour les produits)
